...
//   6: 247.5 .. 292.5 ->  W
//   7: 292.5 .. 337.5 -> NW
int32_t CompassView::computeRangeIndex(float angle_deg)
{
...
void CompassView::handleDragEvent(const touchgfx::DragEvent& event)
{
...
void CompassView::handleGestureEvent(const touchgfx::GestureEvent& event)
{
...
bool CompassView::Wheel::update(float dt)
{
